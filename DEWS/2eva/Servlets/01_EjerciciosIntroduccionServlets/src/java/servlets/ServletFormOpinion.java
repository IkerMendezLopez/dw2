...
public class ServletFormOpinion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<form method='get' action='ServletFormOpinion'>");
            out.println("<label><b>Nombre:</b></label>");
            out.println("<input type='text'><br><br>");
            out.println("<label><b>Apellidos:</b></label>");
            out.println("<input type='text'><br><br>");
            out.println("<label><b>Opinion que le a merecido este sitio web</b></label><br>");
            ...
            out.println("<textarea rows='10' cols='40'></textarea><br><br>");
            out.println("<label><b>Tus secciones favoritas</b></label><br><br>");
            out.println("<input type='submit' value='Enviar Opinion'>");
            out.println("</form>");
            out.println("</body>");
            out.println("</html>");
        }

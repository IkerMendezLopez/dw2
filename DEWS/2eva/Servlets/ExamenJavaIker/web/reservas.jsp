...
<html>
    ...
    <body>
        <h1>Reservas</h1>
        <c:if test="${lstAnulaciones!=null && lstAnulaciones.size()!=0}">
            <p><a href="ServletReservas?grabar=true">Anular reservas marcadas</a></p>
        </c:if>
                            ...
                            <c:if test="${reserva!=null && reserva==loop1.index}">
                                ...
                                <tr>
                                    ...
                                    <c:if test="${reserva.getPagado()==1}">
                                        ...
                                        <c:if test="${lstAnulaciones.contains(reserva.getId_reserva())}">
